...
data_og = pd.read_csv('~/Desktop/Thesis/Data/data_full.csv', index_col = 0)
...
data_sg = data_og[data_og['case_id'].isin(general_cases)]
data = data_sg[data_sg['gender'] == "F"]
print(len(data))
