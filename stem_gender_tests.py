...
from nltk.tokenize import word_tokenize #Count Vectorization does the same thing
...
vectorizer = CountVectorizer(analyzer='word', token_pattern = r'(?u)\b\w+\b', ngram_range=(1,2), min_df = .05)#.01)
...
# print(nb_acc[maxes])
# ideal_alpha = m[maxes]#0.018#m[maxes]
